...
//  InstagramFirebase
//
//  Created by Gin Imor on 3/17/21.
...
class CameraController: UIViewController, AVCaptureFileOutputRecordingDelegate, ItemSelectionControllerDelegate {
  ...
  @IBAction func toggleSemanticSegmentationMatteDeliveryMode(_ semanticSegmentationMatteDeliveryButton: UIButton) {
    let itemSelectionViewController = ItemSelectionController(delegate: self,
  ...
  private func presentItemSelectionViewController(_ itemSelectionViewController: ItemSelectionController) {
  ...
  func itemSelectionViewController(_ itemSelectionViewController: ItemSelectionController,
